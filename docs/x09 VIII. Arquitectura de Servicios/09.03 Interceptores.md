  ...
  login(): void {
    this.authService.login(this.username, this.password).subscribe(
      (response) => {
        ...
        localStorage.setItem('jwt_token', response as string);
...
3. Abrir la consola del navegador, confirmar que si le generó el token jwt y lo redirigió al inicio de la aplicación
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkwNDcyODIxNCwxMzMxMzM3OTI5LC0xOD
k2MzA4NDE1LDU4Nzg5NjgzMiw5MDA1MjAwNjUsLTEyNDcwODU2
NDEsMTcyODg4ODc1LC0xNDUyMTE5NzcsLTg0MzA1OTM5NiwtMT
U3ODYwMDgyOF19
-->