...
En la línea de comandos del proyecto angular ejecutar el siguiente comando

```shell
ng generate interceptor core/
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbODY2OTcwNzk1LC0xNDUyMTE5NzcsLTg0Mz
